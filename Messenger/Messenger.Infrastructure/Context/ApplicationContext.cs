        ...
        public class ApplicationContext : IdentityDbContext<User, UserRole, Guid>
        {
            ...
            private void SeedData(ModelBuilder modelBuilder)
            {
                ...
                modelBuilder.Entity<UserRole>().HasData(
                    new UserRole { Id = memberRoleId, Name = "User", NormalizedName = "USER" },
                    new UserRole { Id = adminRoleId, Name = "Admin", NormalizedName = "ADMIN" }
                );

                modelBuilder.Entity<IdentityUserRole<Guid>>().HasData(
                    new IdentityUserRole<Guid> { UserId = john.Id, RoleId = adminRoleId },
                    new IdentityUserRole<Guid> { UserId = jane.Id, RoleId = memberRoleId },
                    new IdentityUserRole<Guid> { UserId = michael.Id, RoleId = memberRoleId }
                );         
            }
        }
    }
